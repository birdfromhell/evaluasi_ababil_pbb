...
class _MyAppState extends State<MyApp> {
  final List<String> productImages = [
    'assets/images/tshirt-01.jpg',
    'assets/images/hat.jpg',
    'assets/images/knitwear.jpg',
  ];
  ...
  final List<String> productDescriptions = [
    ...
    'Stylish hat to complete your outfit.',
    'Warm and cozy knitwear for cold weather.',
  ];
                  ...
                  (index) => Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 10),
                        Text(
                          productDescriptions[index], // Updated line
                          style: TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                          ),
